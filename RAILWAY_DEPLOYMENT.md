...
# CRITICAL for GBP post images (OpenAI has no public URL like Runway):
# Must be the *backend* API domain — NOT the frontend SPA (e.g. not rankpilot-serp-ai).
PUBLIC_API_BASE_URL      = https://your-backend.up.railway.app
# Optional but recommended — durable image hosts for Google sourceUrl:
# FREEIMAGE_API_KEY      = ...
# IMGBB_API_KEY          = ...
SENDGRID_API_KEY         = SG...
